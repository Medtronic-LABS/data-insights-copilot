...
from backend.models.query_plan import (
    ...
    JoinSpec, AggFunction, ComparisonOperator,
    SchemaLinkResult
)
...
class QueryPlanner:
    ...
    def __init__(self, llm: ChatOpenAI, schema_graph: Optional[SchemaGraph] = None):
        """
    ...
    def _inject_default_filters(self, plan: QueryPlan, link_result: SchemaLinkResult) -> QueryPlan:
    ...
    def _fallback_plan(self, question: str, link_result: Optional[SchemaLinkResult] = None) -> QueryPlan:
