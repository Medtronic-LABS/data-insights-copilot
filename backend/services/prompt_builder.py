...
from backend.models.query_plan import QueryPlan, SchemaLinkResult
...
class PromptBuilder:
    ...
    def _build_constraints_section(self, dialect: str) -> str:
        ...
        constraints.extend([
            "",
            "SPECIAL QUERY PATTERNS:",
            "- LOOKUP QUERIES (\"which org is X\", \"info about patient Y\"): Return ALL relevant columns for the entity",
    ...
    def build_response_format_prompt(
        ...
        This is a pass-through for the existing _format_response logic,
        kept separate from SQL generation prompting.
        """
        # This delegates to the existing format_response prompt structure
        # in sql_service.py — no change needed here
        return ""
